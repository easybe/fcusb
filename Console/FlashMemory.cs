...
namespace FlashMemory
{
    ...
    public class FlashDatabase
    {
        ...
        private void NAND_Database() {
            ...
            FlashDB.Add(new P_NAND("MXIC MX30LF1208AA", 0xC2, 0xF0801D, 2048, 64, 64, 512, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30LF1GE8AB", 0xC2, 0xF1809582U, 2048, 64, 64, 1024, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30UF1G18AC", 0xC2, 0xA1801502U, 2048, 64, 64, 1024, VCC_IF.X8_1V8));
            FlashDB.Add(new P_NAND("MXIC MX30LF1G18AC", 0xC2, 0xF1809502U, 2048, 64, 64, 1024, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30LF1G08AA", 0xC2, 0xF1801D, 2048, 64, 64, 1024, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30LF2G18AC", 0xC2, 0xDA909506U, 2048, 64, 64, 2048, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30UF2G18AC", 0xC2, 0xAA901506U, 2048, 64, 64, 2048, VCC_IF.X8_1V8));
            FlashDB.Add(new P_NAND("MXIC MX30LF2G28AB", 0xC2, 0xDA909507U, 2048, 64, 64, 2048, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30LF2GE8AB", 0xC2, 0xDA909586U, 2048, 64, 64, 2048, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30UF2G18AB", 0xC2, 0xBA905506U, 2048, 64, 64, 2048, VCC_IF.X8_1V8));
            FlashDB.Add(new P_NAND("MXIC MX30UF2G28AB", 0xC2, 0xAA901507U, 2048, 112, 64, 1024, VCC_IF.X8_1V8));
            FlashDB.Add(new P_NAND("MXIC MX30LF4G18AC", 0xC2, 0xDC909556U, 2048, 64, 64, 4096, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30UF4G18AB", 0xC2, 0xAC901556U, 2048, 64, 64, 4096, VCC_IF.X8_1V8));
            FlashDB.Add(new P_NAND("MXIC MX30LF2G28AB", 0xC2, 0xDC909507U, 2048, 112, 64, 2048, VCC_IF.X8_3V)); //2-plane (8-bit ECC)
            FlashDB.Add(new P_NAND("MXIC MX30LF4G28AB", 0xC2, 0xDC909557U, 2048, 112, 64, 4096, VCC_IF.X8_3V)); //2-plane (8-bit ECC)
            FlashDB.Add(new P_NAND("MXIC MX30LF4GE8AB", 0xC2, 0xDC9095D6U, 2048, 64, 64, 4096, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX30UF4G28AB", 0xC2, 0xAC901557U, 2048, 112, 64, 2048, VCC_IF.X8_1V8));
            FlashDB.Add(new P_NAND("MXIC MX60LF8G18AC", 0xC2, 0xD3D1955AU, 2048, 64, 64, 8192, VCC_IF.X8_3V));
            FlashDB.Add(new P_NAND("MXIC MX60LF8G28AB", 0xC2, 0xD3D1955BU, 2048, 64, 64, 8192, VCC_IF.X8_3V));
