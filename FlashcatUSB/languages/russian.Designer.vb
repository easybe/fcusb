...
Namespace My.Resources
    ...
    Friend Class russian
        ...
        '''<summary>
        '''  Looks up a localized string similar to Байты адреса: 0x{0}.
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to Невозможно обнаружить совместимое SPI устройство (Порт {0}).
        '''</summary>
