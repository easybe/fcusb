...
#End Region
    ...
    Public Class FlashDatabase
        ...
        Private Sub NAND_Database()
            ...
            FlashDB.Add(New P_NAND("Hynix HY27UBG8T2B", &HAD, &HD794DA74UI, 8192, 640, 0, 0, VCC_IF.X8_3V)) '32Gb 16Mbit blocks
            FlashDB.Add(New P_NAND("Hynix H27UBG8T2C", &HAD, &HD7949160UI, 8192, 640, 0, 0, VCC_IF.X8_3V)) '32Gb
            ...
            FlashDB.Add(New P_NAND("Zentel A5U1GA31ATS", &H92, &HF1809540UI, 2048, 64, 64, 1024, VCC_IF.X8_3V))
...
#End Region
    ...
    Public Module NAND_LAYOUT_TOOL
        ...
        Public Function NANDLAYOUT_Get(nand_dev As Device) As NANDLAYOUT_STRUCTURE
        ...
        Public Function GetNandPageAddress(nand_dev As Device, gui_addr As UInt32, memory_area As FlashArea) As UInt32
