Public Class HexEditor_v2
    ...
    Public Event AddressUpdate(top_address As Long) 'Updates the TopAddress
    Public Event RequestData(address As Long, ByRef data() As Byte)
    ...
    Public Sub CreateHexViewer(Base As Long, Size As Long)
        ResizeControls()
        Me.BaseOffset = Base
        Me.BaseSize = Size
        Me.TopAddress = 0
    ...
    Public Sub CreateHexViewer(Base As Long, PreLoadData() As Byte)
        ResizeControls()
        Me.BaseOffset = Base
    ...
    Public Sub HexEditor_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        Try
