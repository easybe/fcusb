...
#Region "Bytes From"
            ...
            Public Function FromCharStringArray(ByVal str_in() As String) As Byte()
                ...
                For i = 0 To str_in.Length - 1
                    ...
                    End If
                    Dim CurrentLen As Integer = 0
                    If bytes_out IsNot Nothing Then CurrentLen = bytes_out.Length
                    ReDim Preserve bytes_out(CurrentLen + x.Length - 1)
                    Array.Copy(x, 0, bytes_out, bytes_out.Length - x.Length, x.Length)
                Next
                Return bytes_out
            End Function
...
#Region "ArrayHelpers"
        ...
        'Public Sub ArrayAdd(ByRef ToAdd() As Byte, ByRef NewItem As Byte)
        '    ReDim Preserve ToAdd(ToAdd.Length)
        '    ToAdd(ToAdd.Length - 1) = NewItem
        'End Sub

        Public Sub ArrayAdd(ByRef DestinationArray() As UInt32, ByRef NewItem As UInt32)
            ReDim Preserve DestinationArray(DestinationArray.Length)
            DestinationArray(DestinationArray.Length - 1) = NewItem
        End Sub

        Public Sub ArrayAdd(ByRef ToAdd() As String, ByRef NewItem As String)
            ReDim Preserve ToAdd(ToAdd.Length)
            ToAdd(ToAdd.Length - 1) = NewItem
        End Sub
...
#End Region
        ...
        Public Function GetResourceAsBytes(ByVal ResourceName As String) As Byte()
            ...
            Dim FullResourceName As String = asmname.Name & "." & ResourceName
        ...
        Public Sub ReverseByteEndian_8bit(ByRef Data() As Byte)
            Dim i As Integer
            Dim b As Byte
            Dim bo() As Boolean
            For i = 0 To Data.Length - 1
        ...
        Public Sub SwapByteArray_Nibble(ByRef Buffer() As Byte)
        ...
        Public Sub SwapByteArray_Byte(ByRef Buffer() As Byte)
            For i = 0 To Buffer.Length - 1 Step 2
                If Buffer.Length = i + 1 Then Exit Sub 'MOD 2 = 1
        ...
        Public Sub SwapByteArray_Word(ByRef Buffer() As Byte)
            For i = 0 To Buffer.Length - 1 Step 2
                If Buffer.Length = i + 3 Then Exit Sub 'MOD 4 = 1
